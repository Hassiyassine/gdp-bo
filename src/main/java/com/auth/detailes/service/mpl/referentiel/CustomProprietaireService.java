...
import com.auth.detailes.business.repositories.referentiel.ProprietaireRepository;
import com.auth.detailes.service.referentiel.ProprietaireService;
...
@Service
@AllArgsConstructor
public class CustomProprietaireService implements ProprietaireService {
    private final ProprietaireRepository repository;


    @Override
    public Page<Proprietaire> findAll(Object searchObject, Pageable pageable) {
        if (searchObject instanceof ReferentialSearchRequest) {
            ...
            Specification<Proprietaire> specification = (root, criteriaQuery, criteriaBuilder) -> {
    ...
    @Override
    public Optional<Proprietaire> find(Long id) {
    ...
    @Override
    public Proprietaire update(Long id, Proprietaire entity) {
        return null;
    }

    @Override
    public boolean delete(Proprietaire entity) {
        return false;
    }
}
