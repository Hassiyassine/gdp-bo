                            ...
                            <tr>
                              <td style="overflow-wrap: break-word; word-break: break-word; padding: 0px 10px; font-family: georgia, palatino" align="left">
                                <div style="color: #236fa1; line-height: 130%; text-align: center; word-wrap: break-word">
                                  <p dir="ltr" style="font-size: 14px; line-height: 130%; text-align: center"><span style="font-size: 26px; line-height: 33.8px">
                              ...
                              <td style="overflow-wrap: break-word; word-break: break-word; padding: 10px; font-family: georgia, palatino" align="left">
                                <div style="color: #3d3030; line-height: 140%; text-align: center; word-wrap: break-word">
                                  <p style="font-size: 14px; line-height: 140%; text-align: left">
                                    <span style="font-size: 16px; line-height: 22.4px"><span style="line-height: 22.4px; font-size: 16px">
                                      Bonjour Mr (Mme) : ${fullname}
                                    </span></span>
                                  </p>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td style="overflow-wrap: break-word; word-break: break-word; padding: 10px; font-family: georgia, palatino" align="left">
                                <div style="line-height: 140%; text-align: center; word-wrap: break-word">
                                 <p style="font-size: 14px; line-height: 140%; text-align: justify">Matricule / Nom d'utilisateur : <b>  ${login} </b></p>
                                  <br />
                                  <p style="font-size: 14px; line-height: 140%; text-align: justify">Mots de passe : <b> ${password} </b></p>
                                  <br />
                                  ...
                                  <br/>
                                  <p>
                                      Au plaisir de vous retrouver sur le portail SadiTech : SadiTech.com
                                  </p>
                                </div>
                              </td>
                            </tr>
