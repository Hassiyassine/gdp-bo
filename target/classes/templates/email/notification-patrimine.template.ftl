                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="padding-right: 0px; padding-left: 0px" align="center">
                                      <img align="center" border="0" src="https://i.ibb.co/RyChNF5/favicon.png" alt="Image" title="Image" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; display: inline-block !important; border: none; height: auto; float: none; width: 60%; max-width: 600px" width="600" />
                                    </td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td style="overflow-wrap: break-word; word-break: break-word; padding: 10px; font-family: georgia, palatino" align="left">
                                <div style="line-height: 140%; text-align: center; word-wrap: break-word">
                                  ...
                                  <br/>
                                  <p>
                                      Au plaisir de vous retrouver sur le portail SIGMA-TOP : sigma-top.ma
                                  </p>
                                </div>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td style="overflow-wrap: break-word; word-break: break-word; padding: 19px 10px 10px; font-family: georgia, palatino" align="left">
                                <div style="color: #7f87a7; line-height: 140%; text-align: center; word-wrap: break-word">
                                  <p style="font-size: 14px; line-height: 140%">&copy; 2022 Tous les droits sont r&eacute;serv&eacute;s</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
